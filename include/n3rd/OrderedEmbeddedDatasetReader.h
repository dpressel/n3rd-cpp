#ifndef __N3RD_SVM_ORDEREDEMBEDDEDDATASETREADER_H__
#define __N3RD_SVM_ORDEREDEMBEDDEDDATASETREADER_H__
...
namespace n3rd
{
    ...
    class OrderedEmbeddedDatasetReader : public sgdtk::FeatureProvider
    {
    ...
    public:
         ...
         */
        OrderedEmbeddedDatasetReader(std::string embeddings, int padding = 0) :
        ...
        virtual ~OrderedEmbeddedDatasetReader()
        { }
